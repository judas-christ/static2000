...
module.exports = function(state) {
    ...
    ContentModel.prototype = {
        ...
        descendants: function(filter) {
            ...
            var descs = state.contentList.filter(function(v) { return v.path.indexOf(thisPath) === 0 && v.path !== this.path; }, this); //this._children.map(function(v, i) { var kids = v._children.length ? v.descendants() : []; kids.push(v); console.log(kids); return kids; });
