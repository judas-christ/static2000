...
module.exports = function(options, static2000options, state) {
  var finalObject = {};
  options = options || {};
  ...
  minimatch(names, pattern).forEach(function(name) {
    ...
    if(lazy) {
      Object.defineProperty(finalObject, requireName, {
        get: function() {
          return requireFn(name)(static2000options, state.contentList);
        }
      });
    } else {
      finalObject[requireName] = requireFn(name)(static2000options, state.contentList);
    }
  });
